							            	...
							            	<?php if( get_theme_mod('bb_ecommerce_store_slider_title_Show_hide',true) != ''){ ?>
							              	...
							              	<?php if( get_theme_mod('bb_ecommerce_store_slider_button','SHOP NOW') != '' || get_theme_mod('bb_ecommerce_store_slider_button_url') != ''){ ?>
								              	<div class="more-btn my-md-3">            
						                        	<a href="<?php echo esc_url(get_theme_mod('bb_ecommerce_store_slider_button_url','')); ?>"><?php echo esc_html(get_theme_mod('bb_ecommerce_store_slider_button','SHOP NOW'));?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('bb_ecommerce_store_slider_button','SHOP NOW'));?></span></a>
						                        </div>
						                    <?php } ?>		
						                    <?php } ?>            
							            </div>
