...
<div class="container">
	<main role="main" id="maincontent">
		<div class="row">
			<?php if(get_theme_mod( 'bb_ecommerce_store_shop_page_layout','Right Sidebar') == 'Right Sidebar'){ ?>
				...
				<?php } ?>
			<?php } elseif (get_theme_mod( 'bb_ecommerce_store_shop_page_layout','Right Sidebar') == 'Left Sidebar') {?>
				<?php if ( false != $bb_ecommerce_store_shop_page_sidebar ) {?>
					<div class="col-lg-4 col-md-4" id="sidebar">
						<?php dynamic_sidebar('woocommerce_sidebar'); ?>
					</div>
