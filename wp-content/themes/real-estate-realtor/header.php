...
<body <?php body_class(); ?>>
  ...
  <header role="banner" class="position-relative">
    ...
    <div id="header">
      <?php if( get_theme_mod('real_estate_realtor_show_topbar',false) != ''){ ?>
        <div class="topbar py-2">
          <div  class="container">
            <div class="row">
              ...
              <div class="social-icons col-lg-4 col-md-4 align-self-center text-center text-md-end">
                <?php if ( get_theme_mod('real_estate_realtor_facebook_link','') != "" ) {?>
                  <a target="_blank" href="<?php echo esc_attr( get_theme_mod('real_estate_realtor_facebook_link','' )); ?>"><i class="<?php echo esc_attr(get_theme_mod('real_estate_realtor_facebook_icon','fab fa-facebook-f')); ?> me-3"></i></a>
                <?php }?>
                <?php if ( get_theme_mod('real_estate_realtor_twitter_link','') != "" ) {?>
                  <a target="_blank" href="<?php echo esc_attr( get_theme_mod('real_estate_realtor_twitter_link','' )); ?>"><i class="<?php echo esc_attr(get_theme_mod('real_estate_realtor_twitter_icon','fab fa-twitter')); ?> me-3"></i></a>
                <?php }?>
                <?php if ( get_theme_mod('real_estate_realtor_linkdin_link','') != "" ) {?>
                  <a target="_blank" href="<?php echo esc_attr( get_theme_mod('real_estate_realtor_linkdin_link','' )); ?>"><i class="<?php echo esc_attr(get_theme_mod('real_estate_realtor_linkdin_icon','fab fa-linkedin-in')); ?> me-3"></i></a>
                <?php }?>
                <?php if ( get_theme_mod('real_estate_realtor_instagram_link','') != "" ) {?>
                  <a target="_blank" href="<?php echo esc_attr( get_theme_mod('real_estate_realtor_instagram_link','' )); ?>"><i class="<?php echo esc_attr(get_theme_mod('real_estate_realtor_instagram_icon','fab fa-instagram')); ?> me-3"></i></a>
                <?php }?>
                <?php if ( get_theme_mod('real_estate_realtor_pintrest_link','') != "" ) {?>
                  <a target="_blank" href="<?php echo esc_attr( get_theme_mod('real_estate_realtor_pintrest_link','' )); ?>"><i class="<?php echo esc_attr(get_theme_mod('real_estate_realtor_pintrest_icon','fab fa-pinterest-p')); ?>"></i></a>
                <?php }?>
              </div>
            </div>
          </div>
          ...
          <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="<?php if( get_theme_mod( 'real_estate_realtor_site_logo_inline') != '') { ?>col-lg-7 col-md-7 col-7 site-logo-inline"<?php } else { ?>col-lg-12 col-md-12 <?php } ?>">
                    ...
                    if ( $description || is_customize_preview() ) : ?>
                      <?php if( get_theme_mod('real_estate_realtor_site_tagline_enable',false) != ''){ ?>
            ...
            <div class="col-lg-7 col-md-4 col-6 align-self-center">
              <div class="toggle-menu responsive-menu text-end">
                <button role="tab" onclick="real_estate_realtor_menu_open()" class="mobiletoggle"><i class="<?php echo esc_attr(get_theme_mod('real_estate_realtor_responsive_menu_open_icon','fas fa-bars')); ?>"></i><?php echo esc_html( get_theme_mod('real_estate_realtor_open_menu_label', __('Open Menu','real-estate-realtor'))); ?><span class="screen-reader-text"><?php esc_html_e('Open Menu','real-estate-realtor'); ?></span>
                </button>
              </div>
              <div id="navbar-header text-center" class="menu-brand primary-nav">
                ...
                <a href="javascript:void(0)" class="closebtn responsive-menu" onclick="real_estate_realtor_menu_close()"><?php echo esc_html( get_theme_mod('real_estate_realtor_close_menu_label', __('Close Menu','real-estate-realtor'))); ?><i class="<?php echo esc_attr(get_theme_mod('real_estate_realtor_responsive_menu_close_icon','fas fa-times')); ?>"></i><span class="screen-reader-text"><?php esc_html_e('Close Menu','real-estate-realtor'); ?></span></a>
              </div>
            </div>
