<?php
	...
	$real_estate_realtor_custom_css .='input[type="submit"], .topbar p, .login-box i, span.cart-value, .primary-navigation ul ul a:hover, .primary-navigation ul ul a:focus, #slider .carousel-control-prev-icon:hover, #slider .carousel-control-next-icon:hover, .woocommerce span.onsale, .woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button,.woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, nav.woocommerce-MyAccount-navigation ul li, .blog-section h2:after, #comments input[type="submit"].submit, #comments a.comment-reply-link:hover, #comments a.comment-reply-link, #sidebar h3:after, #sidebar input[type="submit"]:hover, #sidebar .tagcloud a:hover, .footer-wp .tagcloud a:hover, .widget_calendar tbody a, .page-content .read-moresec a.button, .copyright-wrapper, .footer-wp h3:after, .footer-wp input[type="submit"] , .pagination a:hover, .pagination .current, .more-btn a:hover, #scrollbutton i, .footer-wp input[type="submit"], .footer-wp button, #sidebar button, .woocommerce .widget_price_filter .ui-slider .ui-slider-range, .woocommerce .widget_price_filter .ui-slider .ui-slider-handle, .topbar a.call1, .woocommerce nav.woocommerce-pagination ul li a, .tags a:hover, .nav-next a:hover, .nav-previous a:hover, #popular-properties .tablinks.active, #header, .pagination a:hover, #sidebar .tagcloud a:hover, .footer-wp .tagcloud a:hover, #sidebar input[type="submit"]:hover, .nav-next a:hover, .nav-previous a:hover, #slider .carousel-control-prev-icon:hover, #slider .carousel-control-next-icon:hover, .postbtn a, .fixed-header, .metabox i:before, .bradcrumbs a, .bradcrumbs span, #sidebar ul li:before, .woocommerce a.added_to_cart, .page-links .post-page-numbers.current span, .page-links a:hover, .footer-wp .widget_block .wp-block-tag-cloud a:hover, #sidebar .widget_block .wp-block-tag-cloud a:hover, .content_box .tag-test-tag .wp-block-tag-cloud a:hover, #sidebar input[type="submit"], .single-post-page .category a, .wp-block-woocommerce-empty-cart-block .wp-block-button a, .wp-block-woocommerce-cart .wc-block-components-totals-coupon a, .wp-block-woocommerce-cart .wc-block-cart__submit-container a, .wp-block-woocommerce-checkout .wc-block-components-totals-coupon a, .wp-block-woocommerce-checkout .wc-block-checkout__actions_row a{';
		$real_estate_realtor_custom_css .='background-color: '.esc_attr($real_estate_realtor_first_color).';';
	$real_estate_realtor_custom_css .='}';

	$real_estate_realtor_custom_css .='.nav-previous a:hover, .nav-next a:hover, #sidebar .textwidget p a:hover, .footer-wp .textwidget p a, .footer-wp a.rsswidget, .footer-wp li a:hover, #sidebar .custom_read_more a:hover, .footer-wp .custom_read_more a, .navigation.post-navigation a:hover, .metabox a:hover, .blog-section h2 a:hover, td.product-name a:hover, .footer-wp h3, .page-template-home-page .icon-color, .toggle-menu i, .listing-btn a, #sidebar ul li a:hover, .category a:hover{';
	...
	$real_estate_realtor_custom_css .='#scrollbutton i, .woocommerce nav.woocommerce-pagination ul li a, .wp-block-woocommerce-empty-cart-block .wp-block-button a{';
			$real_estate_realtor_custom_css .='border-color: '.esc_attr($real_estate_realtor_first_color).';';
	$real_estate_realtor_custom_css .='}';

	$real_estate_realtor_custom_css .='.wp-block-woocommerce-empty-cart-block .wc-block-grid__product-onsale{';
			$real_estate_realtor_custom_css .='background-color: '.esc_attr($real_estate_realtor_first_color).'!important;';
	$real_estate_realtor_custom_css .='}';

	$real_estate_realtor_custom_css .='.wp-block-woocommerce-empty-cart-block .wc-block-grid__product-onsale	{';
			$real_estate_realtor_custom_css .='border-color: '.esc_attr($real_estate_realtor_first_color).'!important;';
	$real_estate_realtor_custom_css .='}';
	...
	$real_estate_realtor_custom_css .='.select2-container--default .select2-selection--single, .woocommerce nav.woocommerce-pagination ul li a:focus, .woocommerce nav.woocommerce-pagination ul li a:hover, .woocommerce nav.woocommerce-pagination ul li span.current, .woocommerce nav.woocommerce-pagination ul li span, .woocommerce .quantity .qty, #sidebar input[type="search"], input[type="search"], a.button, .page-content .read-moresec a.button:hover, .wp-block-button__link{';
			$real_estate_realtor_custom_css .='border-color: '.esc_attr($real_estate_realtor_second_color).';';
	$real_estate_realtor_custom_css .='}';

	$real_estate_realtor_custom_css .='.wp-block-woocommerce-empty-cart-block .wp-block-button a:hover{';
			$real_estate_realtor_custom_css .='background-color: '.esc_attr($real_estate_realtor_second_color).' !important;';
	$real_estate_realtor_custom_css .='}';

	$real_estate_realtor_custom_css .='.wp-block-woocommerce-empty-cart-block .wp-block-button a:hover{';
			$real_estate_realtor_custom_css .='border-color: '.esc_attr($real_estate_realtor_second_color).' !important;';
	$real_estate_realtor_custom_css .='}';
	...
	$real_estate_realtor_custom_css .='.copyright-wrapper{';
		$real_estate_realtor_custom_css .='padding-top: '.esc_attr($real_estate_realtor_footer_text_padding).'px !important; padding-bottom: '.esc_attr($real_estate_realtor_footer_text_padding).'px !important;';
	$real_estate_realtor_custom_css .='}';
	...
	// Footer Attatchment
	$real_estate_realtor_theme_lay = get_theme_mod( 'real_estate_realtor_footer_attatchment','scroll');
	if($real_estate_realtor_theme_lay == 'fixed'){
		$real_estate_realtor_custom_css .='.footer-wp{';
			$real_estate_realtor_custom_css .='background-attachment: fixed;';
		$real_estate_realtor_custom_css .='}';
	}elseif ($real_estate_realtor_theme_lay == 'scroll'){
		$real_estate_realtor_custom_css .='.footer-wp{';
			$real_estate_realtor_custom_css .='background-attachment: scroll;';
		$real_estate_realtor_custom_css .='}';
	}

	// footer heading font size
	$real_estate_realtor_footer_heading_font_size = get_theme_mod('real_estate_realtor_footer_heading_font_size');
	$real_estate_realtor_custom_css .='.footer-wp h3{';
		$real_estate_realtor_custom_css .='font-size: '.esc_attr($real_estate_realtor_footer_heading_font_size).'px;';
	$real_estate_realtor_custom_css .='}';

	$real_estate_realtor_theme_lay = get_theme_mod( 'real_estate_realtor_footer_text_tranform','Capitalize');
    if($real_estate_realtor_theme_lay == 'Uppercase'){
		$real_estate_realtor_custom_css .='.footer-wp h3{';
			$real_estate_realtor_custom_css .='text-transform: Uppercase;';
		$real_estate_realtor_custom_css .='}';
	...
	// footer padding
	$real_estate_realtor_footer_padding = get_theme_mod('real_estate_realtor_footer_padding');
	$real_estate_realtor_custom_css .='.footer-wp{';
		$real_estate_realtor_custom_css .='padding: '.esc_attr($real_estate_realtor_footer_padding).'px !important;';
	$real_estate_realtor_custom_css .='}';
	...
	$real_estate_realtor_scroll_icon_color = get_theme_mod('real_estate_realtor_scroll_icon_color');
	$real_estate_realtor_custom_css .='#scrollbutton i{';
		$real_estate_realtor_custom_css .='color: '.esc_attr($real_estate_realtor_scroll_icon_color).';';
	$real_estate_realtor_custom_css .='}';

	// back to top icon hover color
	$real_estate_realtor_scroll_icon_hover_color = get_theme_mod('real_estate_realtor_scroll_icon_hover_color');
	$real_estate_realtor_custom_css .='#scrollbutton i:hover{';
		$real_estate_realtor_custom_css .='color: '.esc_attr($real_estate_realtor_scroll_icon_hover_color).';';
	$real_estate_realtor_custom_css .='}';

	// back to top bg color
	$real_estate_realtor_scroll_icon_background = get_theme_mod('real_estate_realtor_scroll_icon_background');
	$real_estate_realtor_custom_css .='#scrollbutton i{';
		$real_estate_realtor_custom_css .='background-color: '.esc_attr($real_estate_realtor_scroll_icon_background).';';
		$real_estate_realtor_custom_css .='border-color: '.esc_attr($real_estate_realtor_scroll_icon_background).';';
	$real_estate_realtor_custom_css .='}';

	// back to top bg hover color
	$real_estate_realtor_scroll_icon_bg_hover = get_theme_mod('real_estate_realtor_scroll_icon_bg_hover');
	$real_estate_realtor_custom_css .='#scrollbutton i:hover{';
		$real_estate_realtor_custom_css .='background-color: '.esc_attr($real_estate_realtor_scroll_icon_bg_hover).';';
		$real_estate_realtor_custom_css .='border-color: '.esc_attr($real_estate_realtor_scroll_icon_bg_hover).';';
	$real_estate_realtor_custom_css .='}';
	...
	$real_estate_realtor_theme_lay = get_theme_mod( 'real_estate_realtor_tranform_button_text','Capitalize');
    if($real_estate_realtor_theme_lay == 'Capitalize'){
		$real_estate_realtor_custom_css .='.postbtn a{';
			$real_estate_realtor_custom_css .='';
		$real_estate_realtor_custom_css .='}';
	}else if($real_estate_realtor_theme_lay == 'Lowercase'){
		$real_estate_realtor_custom_css .='.postbtn a{';
	...
	else if($real_estate_realtor_theme_lay == 'Uppercase'){
		$real_estate_realtor_custom_css .='.postbtn a{';
			$real_estate_realtor_custom_css .='text-transform: Uppercase;';
		$real_estate_realtor_custom_css .='}';
	}	
	...
	// button font weight
	$real_estate_realtor_button_font_weight = get_theme_mod( 'real_estate_realtor_button_font_weight','600');
	if($real_estate_realtor_button_font_weight != ''){
		$real_estate_realtor_custom_css .='.postbtn a{';
			$real_estate_realtor_custom_css .='font-weight: '.esc_attr($real_estate_realtor_button_font_weight).';';
		$real_estate_realtor_custom_css .='}';
	}
	...
	$real_estate_realtor_preloader_bg_image = get_theme_mod('real_estate_realtor_preloader_bg_image');
	if($real_estate_realtor_preloader_bg_image != false){
		$real_estate_realtor_custom_css .='.frame{';
			$real_estate_realtor_custom_css .='background: url('.esc_attr($real_estate_realtor_preloader_bg_image).');';
		$real_estate_realtor_custom_css .='}';
	}
    ...
    if($real_estate_realtor_theme_lay == 'With Background'){
		$real_estate_realtor_custom_css .='.inner-service.woocommerce ul.products li.product, .woocommerce-page ul.products li.product,.front-page-content,.background-img-skin{';
	...
	$real_estate_realtor_post_time = get_theme_mod( 'real_estate_realtor_display_post_time',true);
	if($real_estate_realtor_post_time == true && get_theme_mod( 'real_estate_realtor_metafields_time',true) != true){
	...
	$real_estate_realtor_metafields_date = get_theme_mod( 'real_estate_realtor_metafields_date',true);
	$real_estate_realtor_metafields_author = get_theme_mod( 'real_estate_realtor_metafields_author',true);
	$real_estate_realtor_metafields_comment = get_theme_mod( 'real_estate_realtor_metafields_comment',true);
	...
	$real_estate_realtor_slider = get_theme_mod( 'real_estate_realtor_display_slider',true);
	...
	if($real_estate_realtor_preloader == true && get_theme_mod( 'real_estate_realtor_preloader',false) != true){
    	$real_estate_realtor_custom_css .='.frame{';
			$real_estate_realtor_custom_css .='visibility: hidden;';
		$real_estate_realtor_custom_css .='} ';
	}
    if($real_estate_realtor_preloader == true){
    	$real_estate_realtor_custom_css .='@media screen and (max-width:575px) {';
		$real_estate_realtor_custom_css .='.frame{';
			$real_estate_realtor_custom_css .='visibility: visible;';
		$real_estate_realtor_custom_css .='} }';
	...
	$real_estate_realtor_custom_css .='.primary-navigation a, .primary-navigation ul li a{';
		$real_estate_realtor_custom_css .='font-size: '.esc_attr($real_estate_realtor_menu_font_size_option).'px;';
	$real_estate_realtor_custom_css .='}';

	//menu top-bottom padding
	$real_estate_realtor_menu_top_bottom_padding = get_theme_mod('real_estate_realtor_menu_top_bottom_padding');
	$real_estate_realtor_custom_css .='.primary-navigation a, .primary-navigation ul li a{';
		$real_estate_realtor_custom_css .='padding-top: '.esc_attr($real_estate_realtor_menu_top_bottom_padding).'px;';
		$real_estate_realtor_custom_css .='padding-bottom: '.esc_attr($real_estate_realtor_menu_top_bottom_padding).'px;';
	$real_estate_realtor_custom_css .='}';

	//menu left-right padding
	$real_estate_realtor_menu_left_right_padding = get_theme_mod('real_estate_realtor_menu_left_right_padding');
	$real_estate_realtor_custom_css .='.primary-navigation a, .primary-navigation ul li a{';
		$real_estate_realtor_custom_css .='padding-left: '.esc_attr($real_estate_realtor_menu_left_right_padding).'px;';
		$real_estate_realtor_custom_css .='padding-right: '.esc_attr($real_estate_realtor_menu_left_right_padding).'px;';
	$real_estate_realtor_custom_css .='}';

	// Menu Text Transform
	$real_estate_realtor_theme_lay = get_theme_mod( 'real_estate_realtor_text_tranform_menu','Capitalize');
    if($real_estate_realtor_theme_lay == 'Capitalize'){
		$real_estate_realtor_custom_css .='.primary-navigation a, .primary-navigation ul li a{';
			$real_estate_realtor_custom_css .='';
		$real_estate_realtor_custom_css .='}';
	...
	// menu font weight
	$real_estate_realtor_font_weight_option_menu = get_theme_mod( 'real_estate_realtor_font_weight_option_menu','500');
	if($real_estate_realtor_font_weight_option_menu != ''){
		$real_estate_realtor_custom_css .='.primary-navigation a, .primary-navigation ul li a{';
			$real_estate_realtor_custom_css .='font-weight: '.esc_attr($real_estate_realtor_font_weight_option_menu).';';
		$real_estate_realtor_custom_css .='}';
	}
	...
	$real_estate_realtor_custom_css .='.box-image img, .content_box img{';
		$real_estate_realtor_custom_css .='border-radius: '.esc_attr($real_estate_realtor_image_border_radius).'%;';
	$real_estate_realtor_custom_css .='}';
	...
	$real_estate_realtor_single_image_border_radius = get_theme_mod('real_estate_realtor_single_image_border_radius', 0);
	$real_estate_realtor_custom_css .='.feature-box img{';
		$real_estate_realtor_custom_css .='border-radius: '.esc_attr($real_estate_realtor_single_image_border_radius).'%;';
	$real_estate_realtor_custom_css .='}';

	$real_estate_realtor_single_image_box_shadow = get_theme_mod('real_estate_realtor_single_image_box_shadow',0);
	$real_estate_realtor_custom_css .='.feature-box img{';
		$real_estate_realtor_custom_css .='box-shadow: '.esc_attr($real_estate_realtor_single_image_box_shadow).'px '.esc_attr($real_estate_realtor_single_image_box_shadow).'px '.esc_attr($real_estate_realtor_single_image_box_shadow).'px #b5b5b5;';
	$real_estate_realtor_custom_css .='}';

	// category color
	$real_estate_realtor_category_color = get_theme_mod('real_estate_realtor_category_color');
	$real_estate_realtor_custom_css .='.type-post .category ul li a{';
			$real_estate_realtor_custom_css .='color: '.esc_attr($real_estate_realtor_category_color).';';
	$real_estate_realtor_custom_css .='}';

	// category hover color
	$real_estate_realtor_category_hover_color = get_theme_mod('real_estate_realtor_category_hover_color');
	$real_estate_realtor_custom_css .='.type-post .category ul li a:hover{';
			$real_estate_realtor_custom_css .='color: '.esc_attr($real_estate_realtor_category_hover_color).';';
	$real_estate_realtor_custom_css .='}';
	...
	$real_estate_realtor_sticky_header_padding = get_theme_mod('real_estate_realtor_sticky_header_padding', 0);
		$real_estate_realtor_custom_css .='.fixed-header{';
			$real_estate_realtor_custom_css .='padding: '.esc_attr($real_estate_realtor_sticky_header_padding).'px !important;';
		$real_estate_realtor_custom_css .='}';
    ...
    if($real_estate_realtor_post_block_option == 'By Without Block'){
		$real_estate_realtor_custom_css .='.gridbox .inner-service, .related-inner-box, .mainbox-post, .layout2, .layout1, .post_format-post-format-video,.post_format-post-format-image,.post_format-post-format-audio, .post_format-post-format-gallery, .mainbox{';
	...
	// site logo padding 
	$real_estate_realtor_logo_padding = get_theme_mod('real_estate_realtor_logo_padding', '');
	$real_estate_realtor_custom_css .='.logo{';
	$real_estate_realtor_custom_css .='padding: '.esc_attr($real_estate_realtor_logo_padding).'px!important;';
	$real_estate_realtor_custom_css .='}';
	...
	$real_estate_realtor_social_icons_size = get_theme_mod('real_estate_realtor_social_icons_size', 15);
	$real_estate_realtor_custom_css .='.social-icons a{';
		$real_estate_realtor_custom_css .='font-size: '.esc_attr($real_estate_realtor_social_icons_size).'px;';
	$real_estate_realtor_custom_css .='}';

	// site toggle button color
	$real_estate_realtor_toggle_button_color = get_theme_mod('real_estate_realtor_toggle_button_color');
	$real_estate_realtor_custom_css .='.toggle-menu i{';
		$real_estate_realtor_custom_css .='color: '.esc_attr($real_estate_realtor_toggle_button_color).' !important;';
	$real_estate_realtor_custom_css .='}';

	//Copyright text color
	$real_estate_realtor_copyright_text_color = get_theme_mod('real_estate_realtor_copyright_text_color');
	$real_estate_realtor_custom_css .='.copyright-wrapper p, .copyright-wrapper p a{';
		$real_estate_realtor_custom_css .='color: '.esc_attr($real_estate_realtor_copyright_text_color).';';
	$real_estate_realtor_custom_css .='}';
	...
	$real_estate_realtor_custom_css .='.copyright-wrapper{';
		$real_estate_realtor_custom_css .='background-color: '.esc_attr($real_estate_realtor_copyright_text_background).';';
	$real_estate_realtor_custom_css .='}';

	// menu color
	$real_estate_realtor_menu_color = get_theme_mod('real_estate_realtor_menu_color');
	$real_estate_realtor_custom_css .='.primary-navigation a, .primary-navigation ul li a{';
			$real_estate_realtor_custom_css .='color: '.esc_attr($real_estate_realtor_menu_color).' !important;';
	$real_estate_realtor_custom_css .='}';

	// Sub menu color
	$real_estate_realtor_sub_menu_color = get_theme_mod('real_estate_realtor_sub_menu_color');
	$real_estate_realtor_custom_css .='.primary-navigation ul.children a, .primary-navigation ul.children li a{';
			$real_estate_realtor_custom_css .='color: '.esc_attr($real_estate_realtor_sub_menu_color).' !important;';
	$real_estate_realtor_custom_css .='}';

	// menu hover color
	$real_estate_realtor_menu_hover_color = get_theme_mod('real_estate_realtor_menu_hover_color');
	$real_estate_realtor_custom_css .='.primary-navigation a:hover, .primary-navigation ul li a:hover{';
			$real_estate_realtor_custom_css .='color: '.esc_attr($real_estate_realtor_menu_hover_color).' !important;';
	$real_estate_realtor_custom_css .='}';

	// submenu hover color
	$real_estate_realtor_sub_menu_hover_color = get_theme_mod('real_estate_realtor_sub_menu_hover_color');
	$real_estate_realtor_custom_css .='.primary-navigation a:hover, .primary-navigation ul.children li a:hover{';
			$real_estate_realtor_custom_css .='color: '.esc_attr($real_estate_realtor_sub_menu_hover_color).' !important;';
	$real_estate_realtor_custom_css .='}';	

	// Sub menu bg color
	$real_estate_realtor_sub_menu_bg_color = get_theme_mod('real_estate_realtor_sub_menu_bg_color');
	$real_estate_realtor_custom_css .='.primary-navigation ul.children li a{';
			$real_estate_realtor_custom_css .='background-color: '.esc_attr($real_estate_realtor_sub_menu_bg_color).';';
	$real_estate_realtor_custom_css .='}';

	// Sub menu bg hover color
	$real_estate_realtor_sub_menu_bg_hover_color = get_theme_mod('real_estate_realtor_sub_menu_bg_hover_color');
	$real_estate_realtor_custom_css .='.primary-navigation ul.children li a:hover{';
			$real_estate_realtor_custom_css .='background-color: '.esc_attr($real_estate_realtor_sub_menu_bg_hover_color).';';
	$real_estate_realtor_custom_css .='}';

	// topbar padding option
	$real_estate_realtor_topbar_padding_settings = get_theme_mod('real_estate_realtor_topbar_padding_settings', 10);
		$real_estate_realtor_custom_css .='.topbar{';
			$real_estate_realtor_custom_css .='padding: '.esc_attr($real_estate_realtor_topbar_padding_settings).'px !important;';
		$real_estate_realtor_custom_css .='}';

	// site logo margin 
	$real_estate_realtor_logo_margin = get_theme_mod('real_estate_realtor_logo_margin', '');
	$real_estate_realtor_custom_css .='.logo{';
	$real_estate_realtor_custom_css .='margin: '.esc_attr($real_estate_realtor_logo_margin).'px ;';
	$real_estate_realtor_custom_css .='}';

	// responsive slider search
	$real_estate_realtor_sliderbutton = get_theme_mod( 'real_estate_realtor_display_slider_search',true);
	if($real_estate_realtor_sliderbutton == true && get_theme_mod( 'real_estate_realtor_slider_search_box',true) != true){
    	$real_estate_realtor_custom_css .='.search-box{';
			$real_estate_realtor_custom_css .='display:none;';
		$real_estate_realtor_custom_css .='} ';
	}
    if($real_estate_realtor_sliderbutton == true){
    	$real_estate_realtor_custom_css .='@media screen and (max-width:575px) {';
		$real_estate_realtor_custom_css .='.search-box{';
			$real_estate_realtor_custom_css .='display:block;';
		$real_estate_realtor_custom_css .='} }';
	}else if($real_estate_realtor_sliderbutton == false){
		$real_estate_realtor_custom_css .='@media screen and (max-width:575px){';
		$real_estate_realtor_custom_css .='.search-box{';
			$real_estate_realtor_custom_css .='display:none;';
		$real_estate_realtor_custom_css .='} }';
