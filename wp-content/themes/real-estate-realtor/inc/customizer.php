...
function real_estate_realtor_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('real_estate_realtor_logo_padding',array(
		'default'=> '',
		'transport' => 'refresh',
		'sanitize_callback' => 'real_estate_realtor_sanitize_integer'
	));
	$wp_customize->add_control(new Real_Estate_Realtor_Custom_Control( $wp_customize, 'real_estate_realtor_logo_padding',array(
		'label' => esc_html__( 'Logo Padding (px)','real-estate-realtor' ),
		'section'=> 'title_tagline',
		'priority'    => 9,
		'input_attrs' => array(
         'step'  => 1,
	...
	$wp_customize->add_setting('real_estate_realtor_logo_margin',array(
		'default'=> '',
		'transport' => 'refresh',
		'sanitize_callback' => 'real_estate_realtor_sanitize_integer'
	));
	$wp_customize->add_control(new Real_Estate_Realtor_Custom_Control( $wp_customize, 'real_estate_realtor_logo_margin',array(
		'label' => esc_html__( 'Logo Margin  (px)','real-estate-realtor' ),
		'section'=> 'title_tagline',
		'priority'    => 9,
		'input_attrs' => array(
         'step'  => 1,
	...
	//Important Links
	$wp_customize->add_section( 'real_estate_realtor_important_links' , array(
    	'title' => esc_html__( 'Important Links', 'real-estate-realtor' ),
    	'priority' => 10,
	) );

	$wp_customize->add_setting('real_estate_realtor_doc_link',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('real_estate_realtor_doc_link',array(
		'type'=> 'hidden',
		'description' => "<a target='_blank' href='". esc_url('https://buywptemplates.com/demo/docs/free-bwt-real-estate-realtor/') ." '>Documentation</a>",
		'section'=> 'real_estate_realtor_important_links'
	));

	$wp_customize->add_setting('real_estate_realtor_demo_links',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('real_estate_realtor_demo_links',array(
		'type'=> 'hidden',
		'description' => "<a target='_blank' href='". esc_url('https://www.buywptemplates.com/bwt-real-estate-realtor-pro/') ." '>Demo</a>",
		'section'=> 'real_estate_realtor_important_links'
	));

	$wp_customize->add_setting('real_estate_realtor_forum_links',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('real_estate_realtor_forum_links',array(
		'type'=> 'hidden',
		'section'=> 'real_estate_realtor_important_links',
		'description' => "<a target='_blank' href='". esc_url('https://wordpress.org/support/theme/real-estate-realtor/') ." '>Support Forum</a>",
	));
	...
	$wp_customize->add_setting('real_estate_realtor_body_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'real_estate_realtor_body_color', array(
		'label'    => __('Body Color', 'real-estate-realtor'),
		'section'  => 'real_estate_realtor_typography',
		'settings' => 'real_estate_realtor_body_color',
	)));

	$wp_customize->add_setting('real_estate_realtor_body_font_family', array(
		'default'           => '',
		'capability'        => 'edit_theme_options',
		'sanitize_callback' => 'real_estate_realtor_sanitize_choices',
	));
	$wp_customize->add_control(	'real_estate_realtor_body_font_family', array(
		'section' => 'real_estate_realtor_typography',
		'label'   => __('Body Fonts', 'real-estate-realtor'),
		'type'    => 'select',
		'choices' => $real_estate_realtor_font_array,
	));

	$wp_customize->add_setting('real_estate_realtor_body_font_size', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_text_field',
	));
	$wp_customize->add_control('real_estate_realtor_body_font_size', array(
		'label'   => __('Body Font Size', 'real-estate-realtor'),
		'section' => 'real_estate_realtor_typography',
		'setting' => 'real_estate_realtor_body_font_size',
		'type'    => 'text',
	));
	...
	//Show /Hide Topbar
	$wp_customize->add_setting( 'real_estate_realtor_show_topbar',array(
		'default' => false,
      	'sanitize_callback'	=> 'real_estate_realtor_sanitize_checkbox'
    ) );
    $wp_customize->add_control('real_estate_realtor_show_topbar',array(
    	'priority'       => 1,
    	'type' => 'checkbox',
        'label' => __( 'Show / Hide Topbar','real-estate-realtor' ),
        'section' => 'real_estate_realtor_topbar'
    ));

    $wp_customize->add_setting( 'real_estate_realtor_topbar_padding_settings', array(
		'default'=> 10,
		'sanitize_callback'	=> 'sanitize_text_field',
	) );
	$wp_customize->add_control( 'real_estate_realtor_topbar_padding_settings', array(
		'label'       => esc_html__( 'Topbar Padding','real-estate-realtor' ),
		'section'     => 'real_estate_realtor_topbar',
		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
   ...
   $wp_customize->add_setting('real_estate_realtor_listing_btn_icon',array(
	...
	//Menu Settings
	$wp_customize->add_section('real_estate_realtor_menu_settings',array(
		'title'	=> __('Menu Settings','real-estate-realtor'),
		'priority'	=> null,
		'panel' => 'real_estate_realtor_panel_id',
	));
	...
	$wp_customize->add_control(new Real_Estate_Realtor_Custom_Control( $wp_customize,'real_estate_realtor_menu_font_size_option',array(
		...
		'section'=> 'real_estate_realtor_menu_settings',
		'input_attrs' => array(
         'step'             => 1,
			'min'              => 0,
			'max'              => 50,
	...
	$wp_customize->add_setting('real_estate_realtor_menu_top_bottom_padding',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Real_Estate_Realtor_Custom_Control( $wp_customize,'real_estate_realtor_menu_top_bottom_padding',array(
		'label'	=> __('Menu Top-Bottom Padding','real-estate-realtor'),
		'section'=> 'real_estate_realtor_menu_settings',
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
	...
	$wp_customize->add_setting('real_estate_realtor_menu_left_right_padding',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Real_Estate_Realtor_Custom_Control( $wp_customize,'real_estate_realtor_menu_left_right_padding',array(
		'label'	=> __('Menu Left-Right Padding','real-estate-realtor'),
		'section'=> 'real_estate_realtor_menu_settings',
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
    ...
    $wp_customize->add_control('real_estate_realtor_font_weight_option_menu',array(
        ...
        'section' => 'real_estate_realtor_menu_settings',
        'choices' => array(
            '100' => __('100','real-estate-realtor'),
            '200' => __('200','real-estate-realtor'),
            '300' => __('300','real-estate-realtor'),
            '400' => __('400','real-estate-realtor'),
            '500' => __('500','real-estate-realtor'),
            '600' => __('600','real-estate-realtor'),
            '700' => __('700','real-estate-realtor'),
            '800' => __('800','real-estate-realtor'),
            '900' => __('900','real-estate-realtor'),
        ),
	) );

    $wp_customize->add_setting('real_estate_realtor_menu_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'real_estate_realtor_menu_color', array(
		'label'    => __('Menu Color', 'real-estate-realtor'),
		'section'  => 'real_estate_realtor_menu_settings',
		'settings' => 'real_estate_realtor_menu_color',
	)));

	$wp_customize->add_setting('real_estate_realtor_sub_menu_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'real_estate_realtor_sub_menu_color', array(
		'label'    => __('Submenu Color', 'real-estate-realtor'),
		'section'  => 'real_estate_realtor_menu_settings',
		'settings' => 'real_estate_realtor_sub_menu_color',
	)));

	$wp_customize->add_setting('real_estate_realtor_menu_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'real_estate_realtor_menu_hover_color', array(
		'label'    => __('Menu Hover Color', 'real-estate-realtor'),
		'section'  => 'real_estate_realtor_menu_settings',
		'settings' => 'real_estate_realtor_menu_hover_color',
	)));

	$wp_customize->add_setting('real_estate_realtor_sub_menu_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'real_estate_realtor_sub_menu_hover_color', array(
		'label'    => __('Submenu Hover Color', 'real-estate-realtor'),
		'section'  => 'real_estate_realtor_menu_settings',
		'settings' => 'real_estate_realtor_sub_menu_hover_color',
	)));

	$wp_customize->add_setting('real_estate_realtor_sub_menu_bg_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'real_estate_realtor_sub_menu_bg_color', array(
		'label'    => __('Submenu Background Color', 'real-estate-realtor'),
		'section'  => 'real_estate_realtor_menu_settings',
		'settings' => 'real_estate_realtor_sub_menu_bg_color',
	)));

	$wp_customize->add_setting('real_estate_realtor_sub_menu_bg_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'real_estate_realtor_sub_menu_bg_hover_color', array(
		'label'    => __('Submenu Background Hover Color', 'real-estate-realtor'),
		'section'  => 'real_estate_realtor_menu_settings',
		'settings' => 'real_estate_realtor_sub_menu_bg_hover_color',
	)));
   ...
   $wp_customize->add_setting('real_estate_realtor_pintrest_icon',array(
	...
	$wp_customize->add_setting('real_estate_realtor_social_icons_size',array(
		'default'=> 15,
		'sanitize_callback'	=> 'sanitize_text_field',
	));
	$wp_customize->add_control('real_estate_realtor_social_icons_size',array(
		'label'	=> __('Social Icons Size ','real-estate-realtor'),
		'section'=> 'real_estate_realtor_social_section',
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
	...
	$wp_customize->add_setting( 'real_estate_realtor_slider_small_title', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_text_field'
	) );
	$wp_customize->add_control( 'real_estate_realtor_slider_small_title', array(
		'label'    => __( 'Add Slider Small Text', 'real-estate-realtor' ),
		'section'  => 'real_estate_realtor_slider_section',
		'type'     => 'text'
	) );

	$wp_customize->add_setting('real_estate_realtor_slider_small_title_icon',array(
		'default'	=> 'fa fa-home',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Real_Estate_Realtor_Icon_Changer(
        $wp_customize,'real_estate_realtor_slider_small_title_icon',array(
		'label'	=> __('Slider Small Text Icon','real-estate-realtor'),
		'transport' => 'refresh',
		'section'	=> 'real_estate_realtor_slider_section',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('real_estate_realtor_slider_previous_icon',array(
		'default'	=> 'fas fa-chevron-left',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Real_Estate_Realtor_Icon_Changer(
        $wp_customize,'real_estate_realtor_slider_previous_icon',array(
		'label'	=> __('Slider Previous Icon','real-estate-realtor'),
		'transport' => 'refresh',
		'section'	=> 'real_estate_realtor_slider_section',
		'type'		=> 'icon'
	)));

	$wp_customize->add_setting('real_estate_realtor_slider_next_icon',array(
		'default'	=> 'fas fa-chevron-right',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Real_Estate_Realtor_Icon_Changer(
        $wp_customize,'real_estate_realtor_slider_next_icon',array(
		'label'	=> __('Slider Next Icon','real-estate-realtor'),
		'transport' => 'refresh',
		'section'	=> 'real_estate_realtor_slider_section',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting( 'real_estate_realtor_single_page_breadcrumb',array(
		'default' => false,
      'sanitize_callback'	=> 'real_estate_realtor_sanitize_checkbox'
    ));
    $wp_customize->add_control('real_estate_realtor_single_page_breadcrumb',array(
    	'type' => 'checkbox',
      'label' => __( 'Show / Hide Single Page Breadcrumb','real-estate-realtor' ),
	...
	$wp_customize->add_setting('real_estate_realtor_preloader_bg_image',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw',
	));
	$wp_customize->add_control( new WP_Customize_Image_Control($wp_customize,'real_estate_realtor_preloader_bg_image',array(
        'label' => __('Preloader Background Image','real-estate-realtor'),
        'section' => 'real_estate_realtor_option'
	)));
	...
	$wp_customize->add_setting('real_estate_realtor_page_sidebar_options',array(
        'default' => 'One Column',
        'sanitize_callback' => 'real_estate_realtor_sanitize_choices'
	) );
	$wp_customize->add_control('real_estate_realtor_page_sidebar_options', array(
        'type' => 'select',
        'label' => __('Page Sidebar Layout','real-estate-realtor'),
        'section' => 'real_estate_realtor_option',
        'choices' => array(
	...
	$wp_customize->add_control('real_estate_realtor_layout_options', array(
        'type' => 'select',
        'label' => __('Post Sidebar Layout','real-estate-realtor'),
        'section' => 'real_estate_realtor_option',
        'choices' => array(
            'One Column' => __('One Column','real-estate-realtor'),
   ...
   $wp_customize->add_control( 'real_estate_realtor_pagination_settings', array(
	...
	//Button Settings
	$wp_customize->add_section('real_estate_realtor_button_settings', array(
		'title'    => __('Button Settings', 'real-estate-realtor'),
		'panel'    => 'real_estate_realtor_panel_id',
	));
	...
	$wp_customize->add_control('real_estate_realtor_button_text',array(
		'label'	=> __('Add Button Text','real-estate-realtor'),
		'section'=> 'real_estate_realtor_button_settings',
		'type'=> 'text'
	));

	$wp_customize->add_setting('real_estate_realtor_tranform_button_text',array(
        'default' => 'Capitalize',
        'sanitize_callback' => 'real_estate_realtor_sanitize_choices'
   ));
   $wp_customize->add_control('real_estate_realtor_tranform_button_text',array(
        'type' => 'select',
        'label' => __('Button Text Transform','real-estate-realtor'),
        'section' => 'real_estate_realtor_button_settings',
        'choices' => array(
            'Uppercase' => __('Uppercase','real-estate-realtor'),
            'Lowercase' => __('Lowercase','real-estate-realtor'),
	...
	$wp_customize->add_setting('real_estate_realtor_button_font_weight',array(
		'default' => '600',
		'sanitize_callback' => 'real_estate_realtor_sanitize_choices'
 	));
 	$wp_customize->add_control('real_estate_realtor_button_font_weight',array(
		'type' => 'select',
		'label' => __('Button Font Weight','real-estate-realtor'),
		'section' => 'real_estate_realtor_button_settings',
		'choices' => array(
			'100' => __('100','real-estate-realtor'),
			'200' => __('200','real-estate-realtor'),
   ...
   //Single Post Settings
	...
	$wp_customize->add_setting('real_estate_realtor_single_post_bradcrumb',array(
			'default' => false,
			'sanitize_callback'	=> 'real_estate_realtor_sanitize_checkbox'
	));
	$wp_customize->add_control('real_estate_realtor_single_post_bradcrumb',array(
			'type' => 'checkbox',
			'label' => __('Enable / Disable Breadcrumb','real-estate-realtor'),
   ...
   $wp_customize->add_setting( 'real_estate_realtor_single_image_border_radius', array(
		'default'=> 0,
		'sanitize_callback'	=> 'sanitize_text_field'
	) );
	$wp_customize->add_control(new Real_Estate_Realtor_Custom_Control( $wp_customize,  'real_estate_realtor_single_image_border_radius', array(
		'label'       => esc_html__( 'Featured Image Border Radius','real-estate-realtor' ),
		'section'     => 'real_estate_realtor_single_post_settings',
		'type'        => 'number',
		'input_attrs' => array(
	...
	$wp_customize->add_setting( 'real_estate_realtor_single_image_box_shadow',array(
		'default' => 0,
		'type'                 => 'theme_mod',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'absint',
	...
	$wp_customize->add_control(new Real_Estate_Realtor_Custom_Control( $wp_customize,  'real_estate_realtor_single_image_box_shadow',array(
		'label' => esc_html__( 'Featured Image Shadow','real-estate-realtor' ),
		'section' => 'real_estate_realtor_single_post_settings',
		'input_attrs' => array(
			'min' => 0,
   ...
   $wp_customize->add_control('real_estate_realtor_single_post_tags',array(
	...
	$wp_customize->add_setting('real_estate_realtor_show_hide_single_post_categories',array(
			'default' => true,
			'sanitize_callback'	=> 'real_estate_realtor_sanitize_checkbox'
	));
	$wp_customize->add_control('real_estate_realtor_show_hide_single_post_categories',array(
			'type' => 'checkbox',
			'label' => __('Single Post Categories','real-estate-realtor'),
			'section' => 'real_estate_realtor_single_post_settings'
	));

	$wp_customize->add_setting('real_estate_realtor_category_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'real_estate_realtor_category_color', array(
		'label'    => __('Category Color', 'real-estate-realtor'),
		'section'  => 'real_estate_realtor_single_post_settings',
		'settings' => 'real_estate_realtor_category_color',
	)));

	$wp_customize->add_setting('real_estate_realtor_category_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'real_estate_realtor_category_hover_color', array(
		'label'    => __('Category Hover Color', 'real-estate-realtor'),
		'section'  => 'real_estate_realtor_single_post_settings',
		'settings' => 'real_estate_realtor_category_hover_color',
	)));
   ...
   $wp_customize->add_setting('real_estate_realtor_prev_text',array(
       'default' => 'Previous page',
       'sanitize_callback'	=> 'sanitize_text_field'
   ));
   $wp_customize->add_control('real_estate_realtor_prev_text',array(
       'type' => 'text',
       'label' => __('Previous Navigation Text','real-estate-realtor'),
       'section' => 'real_estate_realtor_single_post_settings'
   ));

   $wp_customize->add_setting('real_estate_realtor_next_text',array(
       'default' => 'Next page',
       'sanitize_callback'	=> 'sanitize_text_field'
   ));
   $wp_customize->add_control('real_estate_realtor_next_text',array(
       'type' => 'text',
       'label' => __('Next Navigation Text','real-estate-realtor'),
       'section' => 'real_estate_realtor_single_post_settings'
   )); 
	...
	$wp_customize->add_setting('real_estate_realtor_open_menu_label',array(
       'default' => __('Menu','real-estate-realtor'),
       'sanitize_callback'	=> 'sanitize_text_field'
   ));
   $wp_customize->add_control('real_estate_realtor_open_menu_label',array(
       'type' => 'text',
       'label' => __('Open Menu Label','real-estate-realtor'),
       'section' => 'real_estate_realtor_responsive_media'
   ));
	...
	$wp_customize->add_setting('real_estate_realtor_close_menu_label',array(
       'default' => __('Close Menu','real-estate-realtor'),
       'sanitize_callback' => 'sanitize_text_field'
   ));
   $wp_customize->add_control('real_estate_realtor_close_menu_label',array(
       'type' => 'text',
       'label' => __('Close Menu Label','real-estate-realtor'),
       'section' => 'real_estate_realtor_responsive_media'
   ));

	// site toggle button color
	$wp_customize->add_setting('real_estate_realtor_toggle_button_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'real_estate_realtor_toggle_button_color', array(
		'label'    => __('Toggle Button Color', 'real-estate-realtor'),
		'section'  => 'real_estate_realtor_responsive_media',
		'settings' => 'real_estate_realtor_toggle_button_color',
	)));
    ...
    $wp_customize->add_setting('real_estate_realtor_display_slider_search',array(
	 'default' => true,
	 'sanitize_callback'	=> 'real_estate_realtor_sanitize_checkbox'
	));
	$wp_customize->add_control('real_estate_realtor_display_slider_search',array(
	 'type' => 'checkbox',
	 'label' => __('Display Slider Search','real-estate-realtor'),
	 'section' => 'real_estate_realtor_responsive_media'
	));
   ...
   $wp_customize->add_setting('real_estate_realtor_shop_page_layout', array(
		'default'           => 'Right Sidebar',
		'sanitize_callback' => 'real_estate_realtor_sanitize_choices',
	));
	$wp_customize->add_control('real_estate_realtor_shop_page_layout',array(
		'type'           => 'radio',
		'label'          => __('Shop Page Layout', 'real-estate-realtor'),
		'section'        => 'real_estate_realtor_woocommerce_section',
		'choices'        => array(
			'Left Sidebar'  => __('Left Sidebar', 'real-estate-realtor'),
			'Right Sidebar' => __('Right Sidebar', 'real-estate-realtor'),
   ...
   $wp_customize->add_setting('real_estate_realtor_single_product_page_layout', array(
		'default'           => 'Right Sidebar',
		'sanitize_callback' => 'real_estate_realtor_sanitize_choices',
	));
	$wp_customize->add_control('real_estate_realtor_single_product_page_layout',array(
		'type'           => 'radio',
		'label'          => __('Single Product Page Layout', 'real-estate-realtor'),
		'section'        => 'real_estate_realtor_woocommerce_section',
		'choices'        => array(
			'Left Sidebar'  => __('Left Sidebar', 'real-estate-realtor'),
			'Right Sidebar' => __('Right Sidebar', 'real-estate-realtor'),
   ...
   $wp_customize->add_setting('real_estate_realtor_woo_product_sale_top_bottom_padding',array(
	...
	$wp_customize->add_setting('real_estate_realtor_show_hide_footer',array(
		'default' => true,
		'sanitize_callback'	=> 'real_estate_realtor_sanitize_checkbox'
	));
	$wp_customize->add_control('real_estate_realtor_show_hide_footer',array(
     	'type' => 'checkbox',
      'label' => __('Enable / Disable Footer','real-estate-realtor'),
	...
	$wp_customize->add_setting('real_estate_realtor_footer_attatchment',array(
		'default'=> 'scroll',
		'sanitize_callback'	=> 'real_estate_realtor_sanitize_choices'
	));
	$wp_customize->add_control('real_estate_realtor_footer_attatchment',array(
		'type' => 'select',
		'label'	=> __('Footer Background Attatchment','real-estate-realtor'),
		'choices' => array(
            'fixed' => __('fixed','real-estate-realtor'),
            'scroll' => __('scroll','real-estate-realtor'),
        ),
		'section'=> 'real_estate_realtor_footer_section',
	));

	$wp_customize->add_setting('real_estate_realtor_footer_widget_areas',array(
      'default'           => 4,
      'sanitize_callback' => 'real_estate_realtor_sanitize_choices',
   ));
   $wp_customize->add_control('real_estate_realtor_footer_widget_areas',array(
      'type'        => 'radio',
	...
	$wp_customize->add_setting('real_estate_realtor_footer_heading_font_size',array(
		'default'=> 20,
		'transport' => 'refresh',
		'sanitize_callback' => 'real_estate_realtor_sanitize_integer'
	));
	$wp_customize->add_control(new Real_Estate_Realtor_Custom_Control( $wp_customize, 'real_estate_realtor_footer_heading_font_size',array(
		'label' => esc_html__( 'Footer Heading Font Size','real-estate-realtor' ),
		'section'=> 'real_estate_realtor_footer_section',
		'input_attrs' => array(
         'step'             => 1,
			'min'              => 0,
	...
	$wp_customize->add_setting('real_estate_realtor_footer_text_tranform',array(
		'default' => 'Capitalize',
		'sanitize_callback' => 'real_estate_realtor_sanitize_choices'
 	));
 	$wp_customize->add_control('real_estate_realtor_footer_text_tranform',array(
		'type' => 'select',
		'label' => __('Footer Widget Text Transform','real-estate-realtor'),
		'section' => 'real_estate_realtor_footer_section',
		'choices' => array(
		   'Uppercase' => __('Uppercase','real-estate-realtor'),
		   'Lowercase' => __('Lowercase','real-estate-realtor'),
   ...
   $wp_customize->add_setting('real_estate_realtor_footer_padding',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Real_Estate_Realtor_Custom_Control( $wp_customize,'real_estate_realtor_footer_padding',array(
		'label'	=> __('Footer Widget Padding','real-estate-realtor'),
		'section'=> 'real_estate_realtor_footer_section',
		'input_attrs' => array(
         'step' => 1,
			'min'  => 0,
   ...
   $wp_customize->add_setting('real_estate_realtor_hide_show_scroll',array(
	...
	$wp_customize->add_setting('real_estate_realtor_scroll_icon_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'real_estate_realtor_scroll_icon_color', array(
		'label'    => __('Back to Top Icon Color', 'real-estate-realtor'),
		'section'  => 'real_estate_realtor_footer_section',
	)));

	$wp_customize->add_setting('real_estate_realtor_scroll_icon_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'real_estate_realtor_scroll_icon_hover_color', array(
		'label'    => __('Back to Top Icon hover Color', 'real-estate-realtor'),
		'section'  => 'real_estate_realtor_footer_section',
	)));

	$wp_customize->add_setting('real_estate_realtor_scroll_icon_background', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'real_estate_realtor_scroll_icon_background', array(
		'label'    => __('Back to Top Background Color', 'real-estate-realtor'),
		'section'  => 'real_estate_realtor_footer_section',
	)));

	$wp_customize->add_setting('real_estate_realtor_scroll_icon_bg_hover', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'real_estate_realtor_scroll_icon_bg_hover', array(
		'label'    => __('Back to Top Background Hover Color', 'real-estate-realtor'),
		'section'  => 'real_estate_realtor_footer_section',
	)));
	...
	$wp_customize->add_setting('real_estate_realtor_show_hide_copyright',array(
		'default' => true,
		'sanitize_callback'	=> 'real_estate_realtor_sanitize_checkbox'
	));
	$wp_customize->add_control('real_estate_realtor_show_hide_copyright',array(
     	'type' => 'checkbox',
      'label' => __('Enable / Disable Copyright','real-estate-realtor'),
      'section' => 'real_estate_realtor_footer_section',
	));
	...
	$wp_customize->add_setting('real_estate_realtor_copyright_text_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'real_estate_realtor_copyright_text_color', array(
		'label'    => __('Copyright Text Color', 'real-estate-realtor'),
		'section'  => 'real_estate_realtor_footer_section',
	)));

	$wp_customize->add_setting('real_estate_realtor_copyright_text_background', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'real_estate_realtor_copyright_text_background', array(
		'label'    => __('Copyright Background Color', 'real-estate-realtor'),
		'section'  => 'real_estate_realtor_footer_section',
	)));
