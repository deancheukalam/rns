...
if ( ! class_exists( 'Real_Estate_Realtor_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Real_Estate_Realtor_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Real_Estate_Realtor_WPTT_WebFont_Loader( $url );
