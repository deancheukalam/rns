...
<main role="main" id="skip_content">
  ...
  <?php if( get_theme_mod('real_estate_realtor_slider_hide', false) != '' || get_theme_mod( 'real_estate_realtor_display_slider',true) != ''){ ?>
    <section id="slider" class="m-auto p-0 mw-100">
      ...
      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" data-interval="<?php echo esc_attr($real_estate_realtor_slider_speed); ?>"> 
                ...
                <div class="carousel-caption">
                  <div class="inner_carousel">
                    <div class="carousel-content">
                      <?php if( get_theme_mod('real_estate_realtor_slider_small_title') != '' ){ ?>
                        <div class="mb-1">
                          <span class="slider-badge mb-1"><i class="<?php echo esc_attr(get_theme_mod('real_estate_realtor_slider_small_title_icon','fa fa-home')); ?>"></i><?php echo esc_html(get_theme_mod('real_estate_realtor_slider_small_title',''));?></span>
                        </div>
                      <?php }?>
                      ...
                      <?php if( get_theme_mod('real_estate_realtor_slider_text',true) != ''){ ?>
                        <p><?php $real_estate_realtor_excerpt = get_the_excerpt(); echo esc_html( real_estate_realtor_string_limit_words( $real_estate_realtor_excerpt, esc_attr(get_theme_mod('real_estate_realtor_slider_excerpt_number','15')))); ?></p>
                      <?php } ?>
                      <?php if( get_theme_mod('real_estate_realtor_slider_search_box',true) != '' || get_theme_mod('real_estate_realtor_display_slider_search',true) != '' ){ ?>
        ...
        <a class="carousel-control-prev" data-bs-target="#carouselExampleCaptions" data-bs-slide="prev" role="button">
          <span class="carousel-control-prev-icon rounded-circle" aria-hidden="true"><i class="<?php echo esc_attr(get_theme_mod('real_estate_realtor_slider_previous_icon','fas fa-chevron-left')); ?>"></i></span>
          <span class="screen-reader-text"><?php esc_html_e( 'Previous','real-estate-realtor' );?></span>
        </a>
        <a class="carousel-control-next" data-bs-target="#carouselExampleCaptions" data-bs-slide="next" role="button">
          <span class="carousel-control-next-icon rounded-circle" aria-hidden="true"><i class="<?php echo esc_attr(get_theme_mod('real_estate_realtor_slider_next_icon','fas fa-chevron-right')); ?>"></i></span>
