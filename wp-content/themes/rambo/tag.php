...
<div class="container">
	...
	<div class="blog-sidebar">
		...
		<div class="<?php if( is_active_sidebar('sidebar-1')) echo "span8"; else echo "span12";?> Blog_main">
			<?php 				
				$rambo_tag_page = (get_query_var('paged')) ? get_query_var('paged') : 1;
				$rambo_tag_id=get_query_var('tag_id');
				$rambo_args = array( 'post_type' => 'post','paged'=>$rambo_tag_page,'tag_id' => $rambo_tag_id);
